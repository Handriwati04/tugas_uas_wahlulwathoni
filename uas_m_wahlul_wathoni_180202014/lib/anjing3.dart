...
class AnjingKintamani extends StatefulWidget {
  @override
  State<AnjingKintamani> createState() => _AnjingKintamaniState();
}

class _AnjingKintamaniState extends State<AnjingKintamani> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Kintamani"),
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Image.asset("assets/foto/Kintamani.jpg"),
            Text(
